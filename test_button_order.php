...
<head>
    ...
    <title>Teste - Ordem dos Botões - Bella Curves</title>
...
<body>
    <div class="test-container">
        <div class="test-header">
            <h1>🔧 Teste - Ordem dos Botões</h1>
            <p>Verificando consistência na disposição dos botões entre desktop e mobile</p>
        </div>
        ...
        <div class="test-content">
            <div class="debug-info">
                ...
                <ul>
                    <li><strong>Desktop (Modo Responsivo):</strong> Botões lado a lado horizontalmente</li>
                    <li><strong>Celular Real:</strong> Botões empilhados verticalmente</li>
                    <li><strong>Objetivo:</strong> Garantir comportamento idêntico em ambos</li>
                </ul>
            </div>
            ...
            <div class="button-test-info">
                ...
                <ul>
                    <li><strong>Desktop (≥769px):</strong> Botões "Novo Produto" e "Ver Pedidos" lado a lado</li>
                    <li><strong>Mobile (≤768px):</strong> Botões empilhados verticalmente, um embaixo do outro</li>
                    <li><strong>Consistência:</strong> Mesmo comportamento no modo responsivo e celular real</li>
                </ul>
            </div>
            ...
            <table class="comparison-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Mobile (≤768px)</td>
                        <td>Botões empilhados verticalmente</td>
                        <td class="status-warning">⚠️ Verificar</td>
                    </tr>
                    <tr>
            ...
            <div class="debug-info">
                ...
                <ul>
                    ...
                    <li>✅ Desktop: botões lado a lado</li>
                    <li>✅ Mobile: botões empilhados verticalmente</li>
            ...
            <div class="debug-info">
                ...
                <ul>
                    ...
                    <li><strong>4.</strong> Verifique se os botões têm o mesmo comportamento</li>
